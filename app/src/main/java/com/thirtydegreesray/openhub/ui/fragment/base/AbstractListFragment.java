...
import com.thirtydegreesray.openhub.http.model.BasePaginator;
...
public abstract class AbstractListFragment<P extends IBaseContract.Presenter, A extends BaseAdapter, T extends BasePaginator>
    ...
    protected void initFragment(Bundle savedInstanceState) {
        ...
        recyclerView.setOnScrollListener(new AbstractListFragment.ScrollListener());
    ...
    private ListFragment.ListScrollListener mListScrollListener;

    public void setListScrollListener(ListFragment.ListScrollListener listScrollListener){
